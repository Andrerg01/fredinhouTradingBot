...
for date in testDates:
    ...
    start = date[0] - datetime.timedelta(seconds = epochLength)
    end = date[1]
    
    dataDict = cf.getData(Client, goodAssets, start = start, end = end, granularity = granularity, verbose = False, header = '')
