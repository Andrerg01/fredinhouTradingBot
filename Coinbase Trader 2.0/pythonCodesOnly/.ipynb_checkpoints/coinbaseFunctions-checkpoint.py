...
def getData(Client, asset, start = None, end = None, granularity = None, verbose = True, header = ''):
    """
    Returns a pandas DF with the 'Date', 'Low', 'High', 'Open', 'Close', 'Volume', values for a given asset in the stated period and the given granularity.
    ('Date' is the imdex).    
    """
